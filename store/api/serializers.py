...
from store.models import Category, Product, Cart, State, City, Shop, Order, OrderProduct, request_finished
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            if order:
                ...
                transaction.on_commit(lambda: request_finished.send(sender=None, order=order))
